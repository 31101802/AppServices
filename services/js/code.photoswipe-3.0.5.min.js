			...
			Events: {
				...
				fire: function (obj, type) {
					...
					if (this._isBrowserObject(obj)) {
						...
						event = document.createEvent(isNative ? "HTMLEvents" : "DtoEvents");
						event[isNative ? 'initEvent' : 'initDtoEvent'](type, true, true, window, 1);
...
(function (window, klass, Util) {
		...
		PhotoSwipe.Toolbar.CssClasses = {
			...
			download: 'ps-toolbar-download',
			downloadDisabled: 'ps-toolbar-download-disabled'
		};
		...
		PhotoSwipe.Toolbar.getToolbar = function () {
			...
			return '<div class="' + PhotoSwipe.Toolbar.CssClasses.close + '"><div class="' + PhotoSwipe.Toolbar.CssClasses.toolbarContent + '"></div></div><div class="' + PhotoSwipe.Toolbar.CssClasses.play + '"><div class="' + PhotoSwipe.Toolbar.CssClasses.toolbarContent + '"></div></div><div class="' + PhotoSwipe.Toolbar.CssClasses.previous + '"><div class="' + PhotoSwipe.Toolbar.CssClasses.toolbarContent + '"></div></div><div class="' + PhotoSwipe.Toolbar.CssClasses.next + '"><div class="' + PhotoSwipe.Toolbar.CssClasses.toolbarContent + '"></div></div><div class="' + PhotoSwipe.Toolbar.CssClasses.download + '"><div class="' + PhotoSwipe.Toolbar.CssClasses.toolbarContent + '"></div></div>';
...
(function (window, klass, Util) {
		...
		PhotoSwipe.Toolbar.ToolbarClass = klass({
			...
			initialize: function (cache, options) {
				...
				this.downloadEl = Util.DOM.find('.' + PhotoSwipe.Toolbar.CssClasses.download, this.downloadEl)[0];
			...
			handleTap: function (e) {
				...
				else if (e.target === this.downloadEl || Util.DOM.isChildOf(e.target, this.downloadEl) || e.target.parentNode.className === PhotoSwipe.Toolbar.ToolbarAction.download) {
				    action = PhotoSwipe.Toolbar.ToolbarAction.download;
				}
...
(function (window, klass, Util) {
		...
		Util.registerNamespace('Code.PhotoSwipe.DtoLayer');
		var PhotoSwipe = window.Code.PhotoSwipe;

		PhotoSwipe.DtoLayer.CssClasses = {
			uiLayer: 'ps-uilayer'
		};
...
(function (window, klass, Util) {
		...
		PhotoSwipe.DtoLayer.DtoLayerClass = Util.TouchElement.TouchElementClass.extend({
			...
			initialize: function (options) {
				...
				this.el = Util.DOM.createElement(
					'div', {
						'class': PhotoSwipe.DtoLayer.CssClasses.uiLayer
					},
					''
				);
				Util.DOM.setStyle(this.el, {
...
(function (window, klass, Util, Cache, DocumentOverlay, Carousel, Toolbar, DtoLayer, ZoomPanRotate) {
		...
		PhotoSwipe.PhotoSwipeClass = klass({
			...
			initialize: function (images, options, id) {
				...
				this.settings = {
					...
					enableDtoWebViewRepositionTimeout: false,
			...
			createComponents: function () {
				...
				this.uiLayer = new DtoLayer.DtoLayerClass(this.settings);
			...
			addEventHandlers: function () {
				...
				if (Util.isNothing(this.windowOrientationChangeHandler)) {
					...
					this.uiLayerTouchHandler = this.onDtoLayerTouch.bind(this);
			...
			hide: function () {
				...
				this.clearDtoWebViewResetPositionTimeout();
            ...
            download: function () {
                ...
                var image=this.cache.images[this.currentIndex].originalSrc
                this.el = Util.DOM.createElement(
					'a', {
					    'href': image,
					    'download': 'Image'
			...
			onDocumentOverlayFadeIn: function (e) {
				...
				window.setTimeout(function () {
					...
					this.setDtoWebViewResetPositionTimeout();
			...
			/*
			 * Function: setDtoWebViewResetPositionTimeout
			 */
			setDtoWebViewResetPositionTimeout: function () {

				if (!this.settings.enableDtoWebViewRepositionTimeout) {
					return;
				}
			...
			/*
			 * Function: clearDtoWebViewResetPositionTimeout
			 */
			clearDtoWebViewResetPositionTimeout: function () {
				if (!Util.isNothing(this._uiWebViewResetPositionTimeout)) {
					window.clearTimeout(this._uiWebViewResetPositionTimeout);
				}
			},
			...
			/*
			 * Function: onDtoLayerTouch
			 */
			onDtoLayerTouch: function (e) {
			...
			onToolbarTap: function (e) {
				...
				case Toolbar.ToolbarAction.play:
					this.play();
					break;
				case Toolbar.ToolbarAction.download:
				    this.download();
				    break;
				}
	...
	(
		...
		window.Code.PhotoSwipe.DtoLayer,
