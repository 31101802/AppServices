...
ko.utils = new (function () {
    ...
    var keyEventTypeName = /Firefox\/2/i.test(navigator.userAgent) ? 'KeyboardEvent' : 'DtoEvents';
...
ko.bindingHandlers['value'] = {
    ...
    'update': function (element, valueAccessor) {
        ...
        // because you're not allowed to have a model value that disagrees with a visible Dto selection.
